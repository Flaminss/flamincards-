      ...
      <div className="px-4 sm:px-10">
        <div className="mt-32 max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-12 mt-16">
            <div className="text-center bg-[#111] px-6 py-8 rounded-2xl">
              ...
              <p className="text-gray-400">
                Customize our product to perfectly align with your brand and meet
            ...
            <div className="text-center bg-[#111] px-6 py-8 rounded-2xl">
              ...
              <p className="text-gray-400">
                Rest easy knowing that your data is safeguarded by the latest and
                most robust security measures available.
              </p>
              <a
                href="javascript:void(0);"
                className="text-blue-600 inline-block mt-4 hover:underline"
            ...
            <div className="text-center bg-[#111] px-6 py-8 rounded-2xl">
              ...
              <p className="text-gray-400">
                Get prompt and reliable assistance with our 24/7 customer support
        ...
        <div className="max-w-4xl mx-auto text-center mt-32">
          <div>
            ...
            <p className="text-gray-400">
              Unlock creativity with our versatile templates designed to elevate
              your landing pages. Whether you're showcasing products, collecting
              feedback, or promoting events, our templates make the process
              seamless and visually compelling. Qui elit labore in nisi dolore
              tempor anim laboris ipsum ad ad consequat id. Dolore et sint mollit
              in nisi tempor culpa consectetur.
            </p>
          </div>
