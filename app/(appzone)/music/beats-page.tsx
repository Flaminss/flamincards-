      ...
      <nav className="px-4 py-6">
        <div className="flex mb-4 items-center gap-x-4">
          <Input
            ...
            startContent={
              <SearchIcon className="text-black/50 mb-0.5 dark:text-white/90 text-slate-400 pointer-events-none flex-shrink-0 size-4 me-2" />
            }
          />
        ...
        <article className="flex overflow-x-hidden items-center rounded-lg slick-dark-bg p-2 px-4 gap-x-6">
